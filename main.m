...
AddCGFloatFlag(Options, pdfMargins,
...
AddStringFlag(Options, pdfFontFamily,
	@"pdffontfamily", NULL, @"font family to use in the output PDF for all text (defaults to the system control font)")
AddBoolFlag(Options, pdfDebugLayout,
	@"pdfdebuglayout", @"draws guide lines in the output PDF to debug layout")
...
int main(int argc, char *argv[])
{
	...
	if ([options PDF]) {
		...
		p.fontFamily = [options pdfFontFamily];
		p.debugLayout = [options pdfDebugLayout];
